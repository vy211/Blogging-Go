...
function EditPost() {
  ...
  return (
    <form onSubmit={editPost}>
      ...
      <button className="text-xl  rounded-lg font-semibold bg-gray-600 border border-white active:bg-gray-800 active:shadow-none neu-shadow-white p-2 text-white mt-5">
        Edit post
      </button>
    </form>
  );
